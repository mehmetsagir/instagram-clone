  ...
  return (
    <div className={styles.Post}>
      <div className={styles.PostHeader}>
        ...
        <button>
        <svg fill="#262626" height="16" viewBox="0 0 48 48" width="16"><circle cx="8" cy="24"  r="4.5"></circle><circle cx="24" cy="24"  r="4.5"></circle><circle cx="40" cy="24" r="4.5"></circle></svg>
        </button>
      </div>

      <div className={`${styles.PostImage} img-box`} onDoubleClick={() => setLike(!liked)}>
