    ...
    <nav className={styles.Navbar}>
      <div className={`container ${styles.Container}`}>
        ...
        <div className={`${styles.SearchBox} relative`}>
          <input type="text" required placeholder="Search" onClick={() => setSearchModal(true) } />
          <svg viewBox="0 0 512 512">
            <path fill="#ccc" d="M495,466.2L377.2,348.4c29.2-35.6,46.8-81.2,46.8-130.9C424,103.5,331.5,11,217.5,11C103.4,11,11,103.5,11,217.5   S103.4,424,217.5,424c49.7,0,95.2-17.5,130.8-46.7L466.1,495c8,8,20.9,8,28.9,0C503,487.1,503,474.1,495,466.2z M217.5,382.9   C126.2,382.9,52,308.7,52,217.5S126.2,52,217.5,52C308.7,52,383,126.3,383,217.5S308.7,382.9,217.5,382.9z"/>
          </svg>
          {
            searchModal && (
          ...
          <li>
            <Link href="/explore">
              <a>
                {
                  activeClass('/explore') ? (
                    <svg fill="#262626" height="22" viewBox="0 0 48 48" width="22"><path d="M24 0C10.8 0 0 10.8 0 24s10.8 24 24 24 24-10.8 24-24S37.2 0 24 0zm12.2 13.8l-7 14.8c-.1.3-.4.6-.7.7l-14.8 7c-.2.1-.4.1-.6.1-.4 0-.8-.2-1.1-.4-.4-.4-.6-1.1-.3-1.7l7-14.8c.1-.3.4-.6.7-.7l14.8-7c.6-.3 1.3-.2 1.7.3.5.4.6 1.1.3 1.7zm-15 7.4l-5 10.5 10.5-5-5.5-5.5z"></path></svg>
                  ) : (
