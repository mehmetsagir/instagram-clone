  ...
  return (
    <>
      ...
      <ul className={styles.Links}>
        <li className={router.pathname == '/[username]' ? styles.ActiveLink : ''}>
        ...
        <li className={router.pathname == '/[username]/saved' ? styles.ActiveLink : ''}>
