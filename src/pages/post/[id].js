      ...
      <div className={styles.Container}>
        ...
        <div className={styles.Detail}>
          <div className={styles.Header}>
            ...
            <button><svg fill="#262626" height="16" viewBox="0 0 48 48" width="16"><circle cx="8" cy="24" fill-rule="evenodd" r="4.5"></circle><circle clip-rule="evenodd" cx="24" cy="24" fill-rule="evenodd" r="4.5"></circle><circle clip-rule="evenodd" cx="40" cy="24" r="4.5"></circle></svg></button>
          </div>
          ...
          <div className={styles.Actions}>
            ...
            <button onClick={() => setSave(!saved)}>
              {
                saved ? (
                  <svg fill="#262626" height="24" viewBox="0 0 48 48" width="24"><path d="M43.5 48c-.4 0-.8-.2-1.1-.4L24 28.9 5.6 47.6c-.4.4-1.1.6-1.6.3-.6-.2-1-.8-1-1.4v-45C3 .7 3.7 0 4.5 0h39c.8 0 1.5.7 1.5 1.5v45c0 .6-.4 1.2-.9 1.4-.2.1-.4.1-.6.1z"></path></svg>
                ) : (
